...
// //comment iff not want
// app.use("/*", (req, res) => {
//     console.log(" I am * handler");
//     res.status(404).send("this api doesn't exist")s;
// })
...
//mongooooooooooooooooooooooooooouri
let dbURI = 'mongodb+srv://laibaabbas:laiba.4900@webapp.cayqp.mongodb.net/?retryWrites=true&w=majority&appName=webapp';
mongoose.connect(dbURI);

//events to connect mongodb
...
process.on('SIGINT', function () {   //this function will run just before app closing
